...
* **Containerization & Engine:** The project is heavily based on containerization using `podman` (preferred if present in the environment) and falls back to `docker`.
